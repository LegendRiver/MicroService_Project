...
abstract class AbstractCopyHelper
{
    ...
    protected $failedMaterialList;
    protected $failedCopyNameList;
    ...
    private function reset($isResetMaterial=false)
    {
        ...
        $this->failedMaterialList = array();
        $this->failedCopyNameList = array();
        if($isResetMaterial)
        {
    ...
    protected function uploadImageOperation($accountId, $materialPath)
    {
        ...
        $this->failedMaterialList = CommonHelper::getArrayValueByKey(DAResponseField::FAILED_IMAGE_LIST, $imageInfo);
    ...
    protected function uploadVideoOperation($accountId, $materialPath)
    {
        ...
        $this->failedMaterialList = CommonHelper::getArrayValueByKey(DAResponseField::FAILED_VIDEO_LIST, $videoInfo);
     ...
     * @return mixed
     */
    public function getFailedMaterialList()
    {
        return $this->failedMaterialList;
    }

    /**
     * @return mixed
     */
    public function getFailedCopyNameList()
    {
        return $this->failedCopyNameList;
    }
